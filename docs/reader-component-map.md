# Reader Component Interface Map

This document maps Reader Reader components to GraphQL operations and data requirements for integration with Bunny's backend.
