# OmniPane Features and Requirements

This document catalogs all features from OmniPane Reader and defines requirements and user stories for integration with Bunny.
