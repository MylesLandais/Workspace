...
- Saved filter presets (Lumina "Boards")
...
- **Filter-based**: Like Lumina boards (filters applied to all content)
...
- [Integration ADR](./architecture/adr/lumina-feed-integration.md)
