# Lumina Component Interface Map

This document maps Lumina Feed UI components to required interfaces, GraphQL queries/mutations, and integration points with the Bunny architecture.
