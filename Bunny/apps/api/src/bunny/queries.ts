    ...
    return result.records.map((record) => {
      ...
      return {
        ...
        filters: board.filters
          ...
          : { persons: [], sources: [], searchQuery: "" },
        createdAt: board.createdAt
          ? new Date(board.createdAt.toString()).toISOString()
 ...
 */
export async function createSavedBoard(
  userId: string,
  name: string,
  filters: any,
): Promise<SavedBoardData> {
      ...
      return {
        ...
        aliases:
          typeof entity.aliases === "string"
            ...
            : entity.aliases || [],
        contextKeywords:
          typeof entity.context_keywords === "string"
            ? JSON.parse(entity.context_keywords)
            : entity.context_keywords || [],
        imagePool:
          typeof entity.image_pool === "string"
            ? JSON.parse(entity.image_pool)
            : entity.image_pool || [],
      };
    });
  });
