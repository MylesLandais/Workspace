{
  ...
  version = "1.11.2";
  system = "x86_64-linux";
  devenv_root = "/home/warby/Workspace/src/tts";
  project_input_ref = "path:/home/warby/Workspace/src/tts";
  devenv_dotfile = "/home/warby/Workspace/src/tts/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/run/user/1000";
  devenv_runtime = "/run/user/1000/devenv-1a8a13b";
