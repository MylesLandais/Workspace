...
def generate_with_voice(backend, text: str, ref_audio: str, voice_name: str, output_dir: str = "/home/warby/Workspace/outputs/audio", max_chunk: int = 800):
...
def main():
    ...
    print(f"\nOutput files in: /home/warby/Workspace/outputs/audio/")
    for r in results:
